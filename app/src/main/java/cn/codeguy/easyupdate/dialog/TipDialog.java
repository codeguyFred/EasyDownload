...
import cn.codeguy.easyupdate.progressview.DisplayUtil;
import cn.codeguy.easyupdate.progressview.LoadingView;
    ...
    public static class Builder {
        ...
        public TipDialog create(boolean cancelable) {
            ...
            if (mCurrentIconType == ICON_TYPE_LOADING) {
                ...
                loadingView.setSize(DisplayUtil.dip2px(mContext, 32));
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = DisplayUtil.dip2px(mContext, 12);
                }
